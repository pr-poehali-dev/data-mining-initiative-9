  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Найди своё
          <span className="block text-sage">место силы</span>
        </h1>
        ...
        >
          Йога, медитации, гонг, пилатес, МФР и психология. Индивидуальные и групповые практики для восстановления тела и ума.
        </p>
